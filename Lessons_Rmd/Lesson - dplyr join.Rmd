...
knitr::include_graphics("../Images/Join_LeftJoin.pdf")
```
...
```{r, echo=FALSE, out.width = '400pt', fig.align='center'}
knitr::include_graphics("../Images/Join_RightJoin.pdf")
```
...
```{r, echo=FALSE, out.width = '400pt', fig.align='center'}
knitr::include_graphics("../Images/Join_InnerJoin.pdf")
```
...
```{r, echo=FALSE, out.width = '400pt', fig.align='center'}
knitr::include_graphics("../Images/Join_FullJoin.pdf")
```
...
```{r, echo=FALSE, out.width = '400pt', fig.align='center'}
knitr::include_graphics("../Images/Join_AntiJoin.pdf")
```
