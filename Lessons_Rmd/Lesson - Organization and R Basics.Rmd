---
title: "Organization and R basics"
output:
  html_document:
    highlight: tango
    keep_md: yes
...
knitr::include_graphics("Images/RStudio_Startup_xl.png")
```
...
```{r, fig.align='center', out.width='100%', echo=FALSE}
knitr::include_graphics("Images/RStudio_Startup_NewScript_xl.png")
```
...
6. The top left is the **R script** pane.  
	...
	- To execute (run) a section of code in the script pane, you have several options:
		...
		knitr::include_graphics("Images/RStudio_RunButton.png")
		```
...
knitr::include_graphics("Images/SampleFileStructure.png")
```
...
knitr::include_graphics("Images/Rstudio_CommandLineMath.png")
```
...
```{r, fig.align='center', out.width='25%', echo=FALSE}
knitr::include_graphics("Images/RStudio_UnfinishedCommand.png")
```
...
knitr::include_graphics("Images/RStudio_SampleScript.png")
```
